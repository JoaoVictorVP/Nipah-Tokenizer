namespace NipahTokenizer.NanoDesu
{
    public struct Acessor : IMiiExpression, IValue
    {
        ...
        public static bool TryBuildAcessor(Token token, ProgressiveList<Token> tokens, DataStructure data, out Acessor acessor, bool firstWasSetted = true)
        {
            IProgressiveList<Token> _tokens = tokens;
            acessor = default;
            return acessor.Build(token, ref _tokens, ref data, firstWasSetted);
        }
